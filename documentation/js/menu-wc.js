...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">@24vlh/angular-tools documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/PollingHttpOptions.html" data-type="entity-link" >PollingHttpOptions</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/PollingManager.html" data-type="entity-link" >PollingManager</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ServerSentEvent.html" data-type="entity-link" >ServerSentEvent</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/TimeoutBackoffConfigs.html" data-type="entity-link" >TimeoutBackoffConfigs</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/WebsocketExponentialBackoffOptions.html" data-type="entity-link" >WebsocketExponentialBackoffOptions</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
